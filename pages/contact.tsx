    ...
    <div className="relative px-8 py-8 md:py-16 overflow-hidden text-gray-100">
      ...
      >
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl font-semibold leading-tight tracking-wider lg:text-4xl">
              {t.contactTilte}
            </h2>
        ...
        <form
          action="https://formspree.io/f/myyreypd"
          method="POST"
          className="lg:px-12 sm:px-1"
        >
          <div>
            ...
            <input
              className="w-full p-3 mt-2 text-gray-900 rounded-lg bg-homeImg focus:outline-none focus:shadow-outline bg-gray-200"
              type="text"
              name="Sender's Name"
              required
              placeholder=""
          ...
          <div className="mt-8">
            ...
            <textarea
              className="w-full p-3 mt-2 text-gray-900 rounded-lg h-36 bg-homeImg focus:outline-none focus:shadow-outline bg-gray-200"
              required
