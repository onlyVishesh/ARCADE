  ...
  if (snap.current === "material") {
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="text-xl text-justify">
          {t.solarSystemMercuryDescription}
        </p>
      </div>
    );
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="text-xl text-justify">
          {t.solarSystemJupiterDescription}
        </p>
      </div>
    );
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="text-xl text-justify">
          {t.solarSystemNeptuneDescription}
        </p>
      </div>
    );
  } else {
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <div className="grid place-items-center pb-8 mx-8">
          <Image
            src="https://storage.echoar.xyz/wispy-violet-4999/25c8b0c7-d505-419a-9d20-5a443d0e67a0"
            width="250"
            height="250"
            alt="Space QR"
