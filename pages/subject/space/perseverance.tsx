    ...
    >
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <group
            position={[0.51, 0.82, -1.22]}
            rotation={[-Math.PI / 4, -0.38, 0]}
          >
            <mesh
            ...
            <group position={[-4.95, 2.75, 2.32]} rotation={[0, 0, -0.28]}>
              <group position={[-23.49, -6.82, 0.65]} rotation={[0, 0, -1.26]}>
                <group position={[22.47, -0.72, 0.57]} rotation={[0, 0, 1.54]}>
                  <group
                    position={[5.24, -4.55, 1.8]}
                    rotation={[-3.14, -1.41, 0]}
                    scale={[29.85, 29.85, 29.85]}
                  >
          ...
          <group
            position={[-0.02, 1.13, 0.81]}
            rotation={[2.71, -0.77, 0.43]}
          ...
          <group position={[0, 1.16, -1.25]}>
            ...
            <mesh
              ...
              material={materials.array_gold_trim}
            />
            <mesh
  ...
  if (snap.current === "aluminum_black")
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="text-xl text-justify">
          {t.perseverancePowerSourceDetails}
        </p>
      </div>
    );
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        <h1 className="text-3xl uppercase">
          {t.perseveranceNavigationCameras}
        </h1>
        <p className="text-xl text-justify">
          {t.perseveranceNavigationCamerasDetails}
        </p>
      </div>
    );
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="text-xl text-justify">
          {t.perseveranceUHFAntennaDetails}
        </p>
      </div>
    );
  else {
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <p className="self-center my-8 mx-4 text-2xl tracking-wide text-justify">
          {t.modelView}
          <span className="md:hidden"> {t.modelViewResponsive}</span>.
        </p>

        <div className="grid place-items-center pb-8 mx-8">
          <Image
            src="https://storage.echoar.xyz/wispy-violet-4999/6bca4f75-c15c-4754-8227-e9d027561e4f"
            width="250"
            height="250"
            alt="Space QR"
            className="flex p-6 text-6xl rounded-xl h-48 w-48"
          />
          <a href="https://go.echo3d.co/G6xs" target="_blank" rel="noreferrer">
            <button className="h-12 px-8 ml-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-fontVollkorn mt-16 bg-red-50 bg-gradient-to-r from-secondary to-tertiary hover:shadow-lg md:hidden">
              {t.modelViewInAR}
            </button>
          </a>
        </div>
