        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group
                name="hydrogen_0"
                position={[-0.659, 1.952, 0.013]}
                rotation={[-3.12, 0.801, 3.112]}
                scale={0.018}
              >
                <mesh
                  name="Object_4"
                  geometry={nodes.Object_4.geometry}
                  material={materials.VMtl003}
                />
                <mesh
                  name="Object_5"
                  geometry={nodes.Object_5.geometry}
                  material={materials.VMtl001}
                />
              </group>
              <group
                name="fluorine_1"
                position={[-0.531, 1.956, 0.012]}
                rotation={[-3.12, 0.801, 3.112]}
                scale={0.018}
              >
                <mesh
                  ...
                  material={materials.VMtl002}
                />
                <mesh
                  name="Object_8"
                  geometry={nodes.Object_8.geometry}
                  material={materials.VMtl005}
                />
              </group>
              <group
                name="orbital_2"
                position={[-0.463, 1.94, 0.021]}
                rotation={[-3.12, 0.801, 3.112]}
                scale={0.014}
              >
                <mesh
              ...
              <group
                name="orbital002_5"
                position={[0.729, 0.484, 0.011]}
                rotation={[-0.052, -0.784, -0.073]}
                scale={0.018}
              >
                <mesh
                  name="Object_16"
                ...
                <mesh
                  ...
                  material={materials["VMtl002.001"]}
                />
              </group>
              <group
                name="hydrogen001_6"
                position={[-0.69, -0.58, 0.191]}
                rotation={[-3.12, 0.801, 3.112]}
                scale={0.018}
              >
                <mesh
                  ...
                  material={materials["VMtl001.001"]}
                />
                <mesh
                  name="Object_21"
                  geometry={nodes.Object_21.geometry}
                  material={materials["VMtl003.001"]}
                />
              </group>
              <group
                name="fluorine001_7"
                position={[-0.515, -0.576, 0.192]}
                rotation={[-3.12, 0.801, 3.112]}
                scale={0.018}
              >
                <mesh
                ...
                <mesh
                  ...
                  material={materials["VMtl005.001"]}
                />
              </group>
              <group
                name="Orbital001_8"
                position={[-0.468, -0.573, 0.174]}
                rotation={[-3.12, 0.801, 3.112]}
                scale={0.018}
              >
                <mesh
              ...
              <group
                name="hydrogen003_10"
                position={[-2.246, 1.135, 0.002]}
                rotation={[-0.022, -0.801, -0.03]}
                scale={0.018}
              >
                <mesh
                  name="Object_30"
              ...
              <group
                name="s_atomic_orbital002_11"
                position={[-0.463, -0.903, 0.004]}
                rotation={[-0.022, -0.801, -0.03]}
                scale={0.018}
              >
                <mesh
              ...
              <group
                name="s_atomic_orbital004_14"
                position={[1.152, -0.927, 0.004]}
                rotation={[-0.022, -0.801, -0.03]}
                scale={0.018}
              >
                <mesh
              ...
              <group
                name="fluorine003_16"
                position={[2.271, 0.631, 0.02]}
                rotation={[-0.766, 0, -Math.PI / 2]}
                scale={0.018}
              >
                <mesh
                  name="Object_43"
              ...
              <group
                name="fluorine006_18"
                position={[1.46, 0.49, 0.02]}
                rotation={[0.804, 0, -Math.PI / 2]}
                scale={0.018}
              >
                <mesh
                  name="Object_51"
              ...
              <group name="HF_Bonding__33" position={[-1.811, 2.079, 0]}>
                <group
                  name="All_bonding,_antibonding_and_non_bonding_orbitals_29"
                  position={[3.916, -0.218, 0]}
                >
                  <group
                    name="Antibonding_20"
                    position={[-0.404, -0.068, -0.054]}
                    rotation={[-3.12, 0.801, 3.112]}
                    scale={0.018}
                  >
                    <mesh
                  ...
                  <group
                    name="Bonding_orbital_21"
                    position={[-0.415, -0.072, -0.057]}
                    rotation={[-3.12, 0.801, 3.112]}
                    scale={0.018}
                  >
                    <mesh
                  ...
                  <group
                    name="Non_bonding002_24"
                    position={[-0.427, -0.075, -0.059]}
                    rotation={[0.804, 0, -Math.PI / 2]}
                    scale={0.018}
                  >
                    <mesh
                  ...
                  <group
                    name="Non_bonding001_25"
                    position={[-0.418, -0.037, -0.027]}
                    rotation={[-0.766, 0, -Math.PI / 2]}
                    scale={0.018}
                  >
                    <mesh
                ...
                <group
                  name="Energy_diagram001_31"
                  position={[-0.159, -2.317, 0.115]}
                >
                  <group
                    name="Energy_diagram_30"
                    position={[1.722, 1.841, -0.115]}
                    rotation={[Math.PI / 2, 0, 0]}
                  >
                    <mesh
                      name="Object_84"
